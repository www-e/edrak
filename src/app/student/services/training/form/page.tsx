...
export default function StudentTrainingFormPage() {
  ...
  useEffect(() => {
    if (status === 'authenticated' && userId) {
      if (!serviceAccess?.hasAccess) {
        ...
        router.push('/student/services/training/status');
      }
    }
  ...
  if (!serviceAccess?.hasAccess) {
    return (
      <div className="container max-w-4xl mx-auto py-8">
        <Card>
          <CardHeader>
            <CardTitle>Training Program Application</CardTitle>
          </CardHeader>
          <CardContent>
            <Alert variant="destructive">
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                You don&apos;t have access to this service. Please purchase a training program first.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                you have already submitted your training application. You can view your status on the services page.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
  ...
  return (
    <div className="container max-w-4xl mx-auto py-8">
      <Card>
        <CardHeader>
          <CardTitle>Complete Your Training Program Application</CardTitle>
        </CardHeader>
        <CardContent>
