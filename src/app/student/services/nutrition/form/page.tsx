...
export default function StudentNutritionFormPage() {
  ...
  useEffect(() => {
    if (status === 'authenticated' && userId) {
      if (!serviceAccess?.hasAccess) {
        ...
        router.push('/student/services/nutrition/status');
      }
    }
  ...
  if (!serviceAccess?.hasAccess) {
    return (
      <div className="container max-w-4xl mx-auto py-8">
        <Card>
          <CardHeader>
            <CardTitle>Nutrition Application</CardTitle>
          </CardHeader>
          <CardContent>
            <Alert variant="destructive">
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                You don&apos;t have access to this service. Please purchase a nutrition program first.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                You&apos;ve already submitted your nutrition application. You can view your status on the services page.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
  ...
  return (
    <div className="container max-w-4xl mx-auto py-8">
      <Card>
        <CardHeader>
          <CardTitle>Complete Your Nutrition Application</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground mb-6">
            Please fill out this form to help us create your personalized nutrition plan.
          </p>
          <NutritionForm />
        </CardContent>
      </Card>
