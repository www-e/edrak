...
import { useTheme } from 'next-themes'; // This import will now work correctly
      ...
      <div className="container mx-auto flex h-16 max-w-screen-2xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-center gap-x-8">
          <nav className="hidden lg:flex items-center gap-x-6 text-sm font-medium text-muted-foreground">
            <a href="#" className="transition-colors hover:text-foreground flex items-center gap-1">
              مجالات التعلم <ChevronDown className="h-4 w-4" />
            </a>
          </nav>
          ...
          <div className="relative hidden sm:block w-full max-w-xs">
            ...
            <Input 
              placeholder="ابحث" 
              className="w-full rounded-full bg-muted pl-9 pr-4 py-2 text-sm"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-x-4">
          <nav className="hidden lg:flex items-center gap-x-6 text-sm font-medium text-muted-foreground">
            <a href="#" className="transition-colors hover:text-foreground">التخصصات</a>
            <a href="#" className="transition-colors hover:text-foreground">الأدوات</a>
            <a href="#" className="transition-colors hover:text-foreground">الشركاء</a>
          </nav>
